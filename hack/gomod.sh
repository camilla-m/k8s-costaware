...
# Pina a linha `go` em 1.22: e o minimo que k8s v1.31 exige e o que o CI usa.
# Sem isto, `go mod init` com um toolchain mais novo grava algo como `go 1.27`
# e o build do CI (setup-go 1.22) passa a falhar com "requires go >= 1.27".
